...
import 'package:pawly/utils/local_storage/flutter_storage_utility.dart';
...
class SuraEnvFileReader {
  ...
  static Future<String?> fetchUserToken() async {
    ...
    String? token = await AppFlutterStorage().readData(_tokenKey);
  ...
  static Future<void> saveUserToken(String token) async {
    ...
    await AppFlutterStorage().saveData(_tokenKey, token);
  }
  ...
  static Future<void> removeUserToken() async {
    ...
    await AppFlutterStorage().removeData(_tokenKey);
  }
}
